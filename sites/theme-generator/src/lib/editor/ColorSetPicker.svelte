...
<div class="space-y-7">
  <div class="space-y-2">
    ...
    <p class="text-sm text-th-background-700-300 font-light">All the colors of your theme is placed here.</p>
  </div>
    ...
    <ul class="flex items-start gap-2 flex-wrap">
      ...
      <li>
        <button
          ...
          class="w-10 h-10 flex items-center justify-center rounded-lg text-th-background-500 transition hover:scale-110"
        >
